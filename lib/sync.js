...
import { getCollection, listAllItems, createItem, updateItem, publishItems, getSite, publishSite } from './webflow.js';
...
export async function syncJobs({ collectionId, siteId, logger = console } = {}) {
  ...
  const stats = {
    fetched: 0, created: 0, updated: 0, reactivated: 0, archived: 0, published: 0,
    sitePublished: false, resolvedSlugs: null, warnings: [], errors: [],
  };
