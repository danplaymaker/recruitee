...
export async function unpublishItem(collectionId, itemId) {
  try {
    return await request(`/collections/${collectionId}/items/${itemId}/live`, {
      method: 'DELETE',
    });
  } catch (err) {
    // If the item was never published, DELETE /live can 404 — that's fine.
